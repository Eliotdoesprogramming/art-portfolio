package com.talentpath.artportfolio.models.security;
...
public class User {
    ...
    private Set<com.talentpath.artportfolio.models.security.Role> roles = new HashSet<>();
    ...
    public Set<com.talentpath.artportfolio.models.security.Role> getRoles() {
        return roles;
    }

    public void setRoles(Set<com.talentpath.artportfolio.models.security.Role> roles) {
        this.roles = roles;
    }
